...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        #print(" X ", X , " self.weights_input_to_hidden ",  self.weights_input_to_hidden)
        hidden_inputs = np.dot(X,self.weights_input_to_hidden) # signals into hidden layer
        #print(" hidden inputs ",hidden_inputs, " weights hidden to output ",self.weights_hidden_to_output)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        print ( " y " , y, " final_outputs " , final_outputs )
        error = y - final_outputs # Output layer error is the difference between desired target and actual output.
        print ( " error " , error , "self.weights_hidden_to_output",self.weights_hidden_to_output )
    ...
    def run(self, features):
        ...
        #print ( " run final_inputs " , final_inputs , " run final outputs " , final_outputs)
